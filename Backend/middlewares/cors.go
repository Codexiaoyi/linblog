...
func Cors(context interfaces.IContext) {
	...
	context.Response().Header("Access-Control-Max-Age", "172800")
	context.Response().Header("Access-Control-Allow-Credentials", "false")
	context.Response().Header("content-type", "application/json") //// 设置返回格式是json
